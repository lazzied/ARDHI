...
from engines.OCR_processing.models import ScenarioConfig, SiteContext
...
class CropYieldFactory:
    ...
    def build_crop_yield(self,scenario:ScenarioConfig , site: SiteContext):
